...
public class Main {
    public static void Base() {
        EnhancedComputerNetwork network = new EnhancedComputerNetwork("Example Corp", 100, 10.0, 1000.0);
        System.out.println("Q: " + network.calculateQ());
        System.out.println("Qp: " + network.calculateQp());
    }
